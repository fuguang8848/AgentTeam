...
class TestProviderConfirmationConfig:
    ...
    def test_config_creation(self):
        """测试配置创建"""
        config = ProviderConfirmationConfig(high_patterns=[r"\(Y/n\)"], medium_patterns=[r"Continue\?"])
...
class TestConfirmationDetector:
    ...
    def test_init_custom_patterns(self):
        ...
        detector = ConfirmationDetector(high_patterns=custom_high, medium_patterns=custom_medium)
...
class TestConfirmationDetection:
    ...
    def test_detection_creation(self):
        ...
        detection = ConfirmationDetection(
            confidence="high", prompt_text="Allow tool use?", original_line="Allow tool use? (Y/n)"
        )
...
class TestConfirmationDetectorIntegration:
    ...
    def test_provider_specific_config(self):
        """测试 Provider 特定配置"""
        # Claude 特有模式
        config = ProviderConfirmationConfig(high_patterns=[r"Allow\s+\w+\s*\?.*\(y\)"], medium_patterns=[r"Shall I"])
