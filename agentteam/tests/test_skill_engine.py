...
class TestSkillVariable:
    ...
    def test_variable_creation(self):
        """测试变量创建"""
        var = SkillVariable(name="lang", description="目标语言", required=False, default_value="中文")
    ...
    def test_variable_with_options(self):
        """测试带选项的变量"""
        var = SkillVariable(
            name="framework", description="测试框架", type="select", options=["pytest", "unittest", "jest"]
        )
...
class TestSkill:
    ...
    def test_skill_with_variables(self):
        ...
        skill = Skill(
            ...
            input_variables=[SkillVariable(name="lang", description="目标语言", default_value="中文")],
    ...
    def test_skill_auto_timestamp(self):
        """测试自动时间戳"""
        skill = Skill(id="test", name="Test", description="Test", category="test")
...
class TestSkillEngineExpand:
    ...
    def test_expand_simple(self):
        """测试简单展开"""
        skill = Skill(
            id="test", name="Test", description="Test", category="test", prompt_template="处理: {{user_input}}"
        )
    ...
    def test_expand_no_template(self):
        """测试无模板"""
        skill = Skill(id="test", name="Test", description="Test", category="test", prompt_template=None)
    ...
    def test_expand_input_alias(self):
        """测试 input 别名"""
        skill = Skill(id="test", name="Test", description="Test", category="test", prompt_template="处理: {{input}}")
...
class TestSkillEngineValidateVariables:
    ...
    def test_validate_all_provided(self):
        ...
        skill = Skill(
            ...
            description="Test",
            category="test",
            input_variables=[SkillVariable(name="lang", description="目标语言", required=True)],
        )
    ...
    def test_validate_required_with_default(self):
        ...
        skill = Skill(
            ...
            description="Test",
            category="test",
            input_variables=[SkillVariable(name="lang", description="目标语言", required=True, default_value="中文")],
        )
...
class TestSkillEngineHelperMethods:
    ...
    def test_is_compatible_with_provider_all(self):
        """测试兼容所有 Provider"""
        skill = Skill(id="test", name="Test", description="Test", category="test", compatible_providers="all")
    ...
    def test_is_compatible_with_provider_specific(self):
        """测试兼容特定 Provider"""
        skill = Skill(
            id="test", name="Test", description="Test", category="test", compatible_providers=["claude-code", "codex"]
        )
...
class TestSkillEngineProcessCommand:
    ...
    def test_process_skill_command_missing_required(self):
        ...
        skill = Skill(
            ...
            input_variables=[SkillVariable(name="required", description="必填变量", required=True)],
        )
...
class TestSkillEngineIntegration:
    ...
    def test_write_test_skill(self):
        ...
        result = SkillEngine.process_skill_command(skill, "--framework=pytest def add(a, b): return a + b")
    ...
    def test_explain_skill(self):
        ...
        result = SkillEngine.process_skill_command(
            skill, "def factorial(n): return 1 if n <= 1 else n * factorial(n-1)"
        )
