...
from agentteam.concurrency.guard import ConcurrencyGuard, ConcurrencyConfig, ResourceStatus
...
class TestConcurrencyConfig:
    ...
    def test_custom_config(self):
        """测试自定义配置"""
        config = ConcurrencyConfig(max_sessions=5, min_memory_mb=1024, max_cpu_percent=80.0)
