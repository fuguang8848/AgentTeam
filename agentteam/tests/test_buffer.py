...
def buffer_with_callback():
    ...
    buffer = HeadlessTerminalBuffer(cols=80, rows=24, on_screen_update=callback, callback_tail_lines=10)
...
def test_screen_update_info_dataclass():
    ...
    info = ScreenUpdateInfo(last_lines=["Line 1", "Line 2"], total_appended=100)
