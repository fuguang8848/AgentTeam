...
> **Fork de [HKUDS/ClawTeam](https://github.com/HKUDS/ClawTeam)** avec int̩gration approfondie d'OpenClaw : agent `openclaw` par d̩faut, isolation de session par agent, configuration automatique des autorisations d'ex̩cution, et backends de lancement renforc̩s pour la production. Toutes les corrections upstream sont synchronis̩es.
...
> **Branche :** [`feat/per-agent-model-assignment`](https://github.com/win4r/ClawTeam-OpenClaw-OpenClaw/tree/feat/per-agent-model-assignment)
...
Voir [issue #1](https://github.com/win4r/ClawTeam-OpenClaw-OpenClaw/issues/1) pour la demande de fonctionnalit̩ compl̬te et la discussion.
