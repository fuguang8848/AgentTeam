...
class TaskComplexityAnalyzer:
    ...
    COMPLEXITY_KEYWORDS = {
        # Expert level (9-10)
        "expert": [
            "架构设计", "系统架构", "分布式系统", "微服务架构", "高并发", "高并发架构",
            "architecture design", "system architecture", "distributed system",
            "microservices", "high concurrency", "scalability",
            "灾难恢复", "多活", "单元化", "中台", "平台化",
            "service mesh", "kubernetes", "云原生", "CNCF",
            "多机房", "容灾", "异地多活", "全球部署",
            "单元化架构", "分层架构", "CQRS", "ES",
        ],
        # High level (7-8)
        "high": [
            "优化", "性能优化", "重构", "重构代码", "重新设计",
            "optimize", "performance tuning", "refactor", "redesign",
            "多线程", "并发", "异步", "缓存", "队列",
            "multithreading", "concurrency", "async", "cache", "queue",
            "安全", "加密", "认证", "授权", "权限",
            "security", "encryption", "authentication", "authorization",
            "数据库设计", "表结构设计", "索引优化",
            "database design", "schema design", "index optimization",
            "api设计", "接口设计", "协议设计",
            "API design", "interface design", "protocol design",
            "调试", "复杂bug", "根因分析", "troubleshoot", "debug complex",
            "性能瓶颈", "瓶颈分析", "根因定位",
            "数据迁移", "迁移方案", "升级方案",
            "压力测试", "负载测试", "性能测试",
        ],
        # Medium level (5-6)
        "medium": [
            "实现", "编写", "开发", "创建", "implement", "create", "develop",
            "修改", "更新", "添加功能", "modify", "update", "add feature",
            "查询", "统计", "报表", "query", "statistics", "report",
            "验证", "检查", "测试用例", "validate", "verify", "test case",
            "文档", "注释", "说明", "documentation", "comment", "spec",
            "部署", "配置", "安装", "deploy", "configure", "setup",
            "code review", "代码审查", "review", "评审",
        ],
        # Low level (3-4)
        "low": [
            "简单", "小", "修复", "fix", "simple", "small",
            "打印", "输出", "console.log", "print", "echo",
            "变量", "简单逻辑", "variable", "simple logic",
            "格式化", "转换", "format", "convert", "transform",
            "读取", "写入", "文件操作", "read", "write", "file operation",
            "问答题", "是什么", "什么意思", "what is", "how does",
        ],
    }
    ...
    TASK_TYPE_KEYWORDS = {
        TaskType.architecture: [
            "架构", "架构设计", "系统设计", "architecture", "system design",
            "微服务", "service", "mesh", "platform",
        ],
        TaskType.code_generation: [
            "实现", "编写", "创建", "generate", "implement", "create",
            "写代码", "代码生成", "code generation",
        ],
        TaskType.code_review: [
            "review", "审查", "评审", "code review", "代码审查",
            "优化建议", "improvement",
        ],
        TaskType.debugging: [
            "调试", "debug", "bug", "错误", "修复", "fix", "error",
            "问题", "issue", "崩溃", "crash", "异常", "exception",
        ],
        TaskType.documentation: [
            "文档", "说明", "注释", "doc", "comment", "readme",
            "规范", "standard", "specification",
        ],
        TaskType.analysis: [
            "分析", "分析问题", "调研", "analyze", "analysis", "investigate",
            "原因", "为什么", "why", "reason",
        ],
        TaskType.testing: [
            "测试", "test", "用例", "case", "测试用例", "unit test",
            "integration test", "端到端", "e2e",
        ],
        TaskType.refactoring: [
            "重构", "refactor", "重写", "rewrite", "优化代码", "code optimization",
            "清理", "clean up", "代码质量",
        ],
        TaskType.research: [
            "调研", "研究", "research", "对比", "compare", "选型",
            "technology selection", "方案对比",
        ],
        TaskType.general: [
            "帮助", "help", "问题", "question", "ask", "怎么", "how to",
        ],
    }
